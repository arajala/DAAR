...
// void FGPMMOPA6H::parse_gga(gga_t* packet, int i_start) {
// }

// void FGPMMOPA6H::parse_gsa(gsa_t* packet, int i_start) {
// } 
// void FGPMMOPA6H::parse_gsv(gsv_t* packet, int i_start) {
// }

// void FGPMMOPA6H::parse_rmc(rmc_t* packet, int i_start) {
...
// 	// Hours
// 	for (i = 0; i < 2; ++i)
// 		time_buf[i] = serial_buf[i_start++];
// 	packet->utc_hr = (uint8_t)atoi(time_buf);

// 	// Minutes
// 	for (i = 0; i < 2; ++i)
// 		time_buf[i] = serial_buf[i_start++];
// 	packet->utc_min = (uint8_t)atoi(time_buf);

// 	// Seconds
// 	for (i = 0; i < 2; ++i)
// 		time_buf[i] = serial_buf[i_start++];
// 	packet->utc_sec = (uint8_t)atoi(time_buf);
// 	i_start += 5; // fractional seconds and comma

// 	// === Status ===

// 	packet->status = serial_buf[i_start++];

// 	// === Latitude ===

// 	char lat_buf[9];
// 	for (i = 0; i < 9; ++i)
// 		lat_buf[i] = serial_buf[i_start++];
// 	float mins = atof(lat_buf);
// 	float deg = (int)mins / 100.0f;
// 	mins -= deg * 100.0f;
// 	packet->latitude = deg + (mins / 60.0f);
// 	++i_start; // comma

// 	// === N/S Indicator ===

// 	packet->north_south = serial_buf[i_start++];
// 	++i_start; // comma
...
// 	char long_buf[10];
// 	for (i = 0; i < 10; ++i)
// 		long_buf[i] = serial_buf[i_start++];
// 	mins = atof(long_buf);
// 	deg = (int)mins / 100.0f;
// 	mins -= deg * 100.0f;
// 	packet->longitude = deg + (mins / 60.f);
// 	++i_start; // comma

// 	// === E/W Indicator ===

// 	packet->east_west = serial_buf[i_start++];
// 	++i_start; // comma
...
// 	char speed_buf[10];
// 	i = 0;
// 	while ((serial_buf[i_start] != ',') && (i < 10))
// 		speed_buf[i++] = serial_buf[i_start++];
// 	packet->speed_knots = atof(speed_buf);
// 	++i_start; // comma
...
// 	i = 0;
// 	while ((serial_buf[i_start] != ',') && (i < 10))
// 		course_buf[i++] = serial_buf[i_start++];
// 	packet->course = atof(course_buf);
// 	++i_start; // comma
...
// 	// Day
// 	for (i = 0; i < 2; ++i)
// 		date_buf[i] = serial_buf[i_start++];
// 	packet->date_d = (uint8_t)atoi(date_buf);

// 	// Month
// 	for (i = 0; i < 2; ++i)
// 		date_buf[i] = serial_buf[i_start++];
// 	packet->date_m = (uint8_t)atoi(date_buf);

// 	// Year
// 	for (i = 0; i < 2; ++i)
// 		date_buf[i] = serial_buf[i_start++];
// 	packet->date_y = (uint8_t)atoi(date_buf);
// 	++i_start; // comma
...
// 	// i = 0;
// 	// while ((serial_buf[i_start] != ',') && (i < 10))
// 	// 	var_buf[i++] = serial_buf[i_start++];
// 	// packet->mag_var_val = atof(var_buf);
// 	// ++i_start; // comma
// 	// packet->mag_var_dir = serial_buf[i_start++];
// 	// ++i_start; // comma

// 	// === Mode ===

// 	packet->mode = serial_buf[i_start];

// }

// void FGPMMOPA6H::parse_vtg(vtg_t* packet, int i_start) {
// }
